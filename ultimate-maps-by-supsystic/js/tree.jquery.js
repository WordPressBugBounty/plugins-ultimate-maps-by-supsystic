        ...
        (e.prototype.getData = function (e) {
          function t(e) {
            return e.map(function (e) {
              var o = {};
              for (var n in e)
                if (-1 === ['parent', 'children', 'element', 'tree'].indexOf(n) && Object.prototype.hasOwnProperty.call(e, n)) {
                  var r = e[n];
                  o[n] = r;
                }
    ...
    var d = (function () {
      function e(e, t, o) {
        ((this.$element = t),
          ...
          o === i.Position.After ? this.moveAfter() : o === i.Position.Before ? this.moveBefore() : o === i.Position.Inside && (e.isFolder() && e.is_open ? this.moveInsideOpenFolder() : this.moveInside()));
      }
      return (
        (e.prototype.remove = function () {
          this.$ghost.remove();
      ...
      return (
        ...
        (e.prototype.getSelectedNodes = function () {
          ...
          for (var t in this.selected_nodes)
            if (this.selected_nodes.hasOwnProperty(t)) {
        ...
        (e.prototype.getSelectedNodesUnder = function (e) {
          ...
          var t = [];
          for (var o in this.selected_nodes)
            if (this.selected_nodes.hasOwnProperty(o)) {
        ...
        (e.prototype.removeFromSelection = function (e, t) {
          ...
          (void 0 === t && (t = !1),
            null == e.id
              ? this.selected_single_node && e.element === this.selected_single_node.element && (this.selected_single_node = null)
    ...
    var n = (function () {
      ...
      return (
        ...
        (e.prototype.scrollToY = function (e) {
          if ((this.ensureInit(), this.$scroll_parent)) this.$scroll_parent[0].scrollTop = e;
          else {
            var t = this.tree_widget.$el.offset(),
              o = t ? t.top : 0;
        ...
        return (
          ...
          (e.prototype.getState = function () {
            ...
            return {
              open_nodes:
                ((e = []),
                t.tree_widget.tree.iterate(function (t) {
                  return (t.is_open && t.id && t.hasChildren() && e.push(t.id), !0);
                }),
                e),
              selected_node: t.tree_widget.getSelectedNodes().map(function (e) {
                return e.id;
              }),
            };
          }),
          ...
          (e.prototype._openInitialNodes = function (e) {
            for (var t = !1, o = 0, n = e; o < n.length; o++) {
              var r = n[o],
                i = this.tree_widget.getNodeById(r);
          ...
          (e.prototype._setInitialStateOnDemand = function (e, t, o) {
            var n = this,
              ...
              a = function (e) {
                ((r += 1),
                  n.tree_widget._openNode(e, !1, function () {
                    ((r -= 1), s());
                  }));
              };
            s();
      ...
      return (
        ...
        (t.prototype._handleMouseMove = function (e, t) {
          return this.is_mouse_started
            ...
            : !(!this.mouse_delay || this._is_mouse_delay_met) || (this.mouse_down_info && (this.is_mouse_started = !1 !== this._mouseStart(this.mouse_down_info)), this.is_mouse_started ? this._mouseDrag(t) : this._handleMouseUp(t), !this.is_mouse_started);
        }),
        ...
        return (
          ...
          (e.prototype.createFolderLi = function (e, t, o) {
            var n = this.getButtonClasses(e),
              ...
              i = e.is_open ? this.opened_icon_element : this.closed_icon_element,
            ...
            return (
              ...
              this.tree_widget.options.buttonLeft && a.appendChild(l),
          ...
          (e.prototype.createTitleSpan = function (e, t, o, r, i) {
            ...
            return (
              ...
              o && s.setAttribute('tabindex', this.tree_widget.options.tabIndex),
        ...
        return (
            ...
            if (this.current_item && this.drag_element) {
              ...
              return (
                this.canMoveToArea(t) && t
                  ? (t.node.isFolder() || this.stopOpenFolderTimer(), this.hovered_area !== t && ((this.hovered_area = t), this.mustOpenFolderTimer(t) ? this.startOpenFolderTimer(t.node) : this.stopOpenFolderTimer(), this.updateDropHint()))
                  : (this.removeHover(), this.removeDropHint(), this.stopOpenFolderTimer()),
                t || (this.tree_widget.options.onDragMove && this.tree_widget.options.onDragMove(this.current_item.node, e.original_event)),
                !0
              );
            }
            return !1;
          ...
          (e.prototype.mouseStop = function (e) {
            ...
            return (
              ...
              !this.hovered_area && t && this.tree_widget.options.onDragStop && this.tree_widget.options.onDragStop(t.node, e.original_event),
              !1
            );
          }),
          ...
          (e.prototype.moveItem = function (e) {
            ...
            if (this.current_item && this.hovered_area && this.hovered_area.position !== s.Position.None && this.canMoveToArea(this.hovered_area)) {
              var o = this.current_item.node,
                n = this.hovered_area.node,
          ...
          (e.prototype.getTreeDimensions = function () {
            ...
            if (e) {
              var t = this.tree_widget.element,
                o = t.width() || 0,
                n = t.height() || 0,
            ...
            (t._handleClick = function (e) {
              ...
              if (o)
                if ('button' === o.type) (t.toggle(o.node, t.options.slide), e.preventDefault(), e.stopPropagation());
                  ...
                  var n = o.node;
                  t._triggerEvent('tree.click', { node: n, click_event: e }).isDefaultPrevented() || t._selectNode(n, !0);
                }
            }),
        ...
        return (
          ...
          (t.prototype._init = function () {
            (e.prototype._init.call(this),
              ...
              null != u.default ? (this.save_state_handler = new u.default(this)) : (this.options.saveState = !1),
              null != c.default && (this.select_node_handler = new c.default(this)),
              null != a.DragAndDropHandler ? (this.dnd_handler = new a.DragAndDropHandler(this)) : (this.options.dragAndDrop = !1),
              null != p.default && (this.scroll_handler = new p.default(this)),
              null != d.default && null != c.default && (this.key_handler = new d.default(this)),
              this._initData(),
          ...
          (t.prototype._getDataUrlInfo = function (e) {
            ...
            return 'function' == typeof n ? n(e) : 'string' == typeof n ? (r((t = { url: n })), t) : 'object' == typeof n ? (r(n), n) : n;
          }),
          ...
          (t.prototype._selectNode = function (e, t) {
            ...
            if ((void 0 === t && (t = !1), this.select_node_handler)) {
              ...
              if (o.options.onCanSelectNode ? o.options.selectable && o.options.onCanSelectNode(e) : o.options.selectable) {
                if (this.select_node_handler.isNodeSelected(e))
                  t &&
          ...
          (t.prototype._deselectNodes = function (e) {
            if (this.select_node_handler)
              for (var t = 0, o = this.select_node_handler.getSelectedNodesUnder(e); t < o.length; t++) {
                var n = o[t];
          ...
          (t.prototype._loadDataFromUrl = function (e, t, o) {
            ...
            return (
              e || (a = this._getDataUrlInfo(t)),
              (i = t ? s(t.element) : r.element).addClass('jqtree-loading'),
              r._notifyLoading(!0, t, i),
              a
                ? a instanceof Array
                  ? void d(a)
                  : ((n = 'string' == typeof a ? { url: a } : (a.method || (a.method = 'get'), a)),
                    void s.ajax(
                      s.extend({}, n, {
