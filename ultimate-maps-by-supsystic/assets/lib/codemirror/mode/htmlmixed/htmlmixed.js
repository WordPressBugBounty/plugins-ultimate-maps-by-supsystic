    ...
    function (t, n) {
      ...
      if (o)
        for (var u = 0; u < o.length; ++u) {
          var a = o[u];
          s.push({ matches: a.matches, mode: a.mode && e.getMode(t, a.mode) });
        }
      s.push({ matches: /./, mode: e.getMode(t, 'text/plain') });
      return {
        startState: function () {
          var e = r.startState();
          return { token: f, localMode: null, localState: null, htmlState: e };
        },
        ...
        innerMode: function (e) {
          return { state: e.localState || e.htmlState, mode: e.localMode || r };
        },
      };
    },
    'xml',
