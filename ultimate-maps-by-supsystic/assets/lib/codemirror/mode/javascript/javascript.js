  ...
  e.defineMode('javascript', function (t, n) {
    ...
    function m(e, t) {
      ...
      if (n == '"' || n == "'") {
        ...
        if (e.eat('*')) {
          ...
          h(e);
          e.eatWhile(/[gimy]/);
          return v('regexp', 'string-2');
        } else {
          e.eatWhile(l);
          return v('operator', 'operator', e.current());
        }
      } else if (n == '`') {
        t.tokenize = b;
        return b(e, t);
    ...
    function T(e, t) {
      ...
      for (var r = e.context; r; r = r.prev) {
        for (var n = r.vars; n; n = n.next) if (n.name == t) return true;
      }
    }
    function N(e, t, n, r, i) {
      ...
      while (true) {
        ...
        if (u(n, r)) {
          ...
          if (n == 'variable' && T(e, r)) return 'variable-2';
          return t;
        }
      }
    }
    ...
    function A(e) {
      ...
      if (r.context) {
        ...
        if (n.globalVars) r.globalVars = { name: e, next: r.globalVars };
      }
    }
    function M() {
    ...
    function B(e, t) {
      if (e == 'var') return L(D('vardef', t.length), it, H(';'), P);
      if (e == 'keyword a') return L(D('form'), j, B, P);
      if (e == 'keyword b') return L(D('form'), B, P);
      if (e == '{') return L(D('}'), tt, P);
      if (e == ';') return L();
      if (e == 'if') {
        if (C.state.lexical.info == 'else' && C.state.cc[C.state.cc.length - 1] == P) C.state.cc.pop()();
        return L(D('form'), j, B, P, ft);
      }
      if (e == 'function') return L(vt);
      if (e == 'for') return L(D('form'), lt, B, P);
      if (e == 'variable') return L(D('stat'), J);
      if (e == 'switch') return L(D('form'), j, D('}', 'switch'), H('{'), tt, P, P);
      if (e == 'case') return L(j, H(':'));
      if (e == 'default') return L(H(':'));
      if (e == 'catch') return L(D('form'), M, H('('), mt, H(')'), B, P, _);
      if (e == 'module') return L(D('form'), M, Et, _, P);
      if (e == 'class') return L(D('form'), gt, P);
      if (e == 'export') return L(D('form'), St, P);
      if (e == 'import') return L(D('form'), xt, P);
      return k(D('stat'), j, H(';'), P);
    }
    function j(e) {
      return I(e, false);
    }
    ...
    function I(e, t) {
      if (C.state.fatArrowAt == C.stream.start) {
        ...
        else if (e == 'variable') return k(M, st, H('=>'), n, _);
      }
      var r = t ? z : U;
      if (S.hasOwnProperty(e)) return L(r);
      if (e == 'function') return L(vt, r);
      if (e == 'keyword c') return L(t ? R : q);
      if (e == '(') return L(D(')'), q, Lt, H(')'), P, r);
      if (e == 'operator' || e == 'spread') return L(t ? F : j);
      if (e == '[') return L(D(']'), Ct, P, r);
      if (e == '{') return et(Q, '}', null, r);
      if (e == 'quasi') {
        return k(W, r);
      }
      return L();
    ...
    function W(e, t) {
      if (e != 'quasi') return k();
      if (t.slice(t.length - 2) != '${') return L(W);
      return L(j, X);
    }
    function X(e) {
      if (e == '}') {
    ...
    function Q(e, t) {
      if (e == 'variable' || C.style == 'keyword') {
        C.marked = 'property';
        if (t == 'get' || t == 'set') return L(G);
        return L(Y);
      } else if (e == 'number' || e == 'string') {
        C.marked = s ? 'property' : C.style + ' property';
        return L(Y);
    ...
    function ot(e, t) {
      if (e == 'variable' && !C.stream.match(/^\s*:/, false)) {
        A(t);
        return L(ut);
      }
      if (e == 'variable') C.marked = 'property';
      return L(H(':'), st, ut);
    }
    function ut(e, t) {
      if (t == '=') return L(F);
    ...
    function ct(e) {
      if (e == 'var') return L(it, H(';'), pt);
      if (e == ';') return L(pt);
      if (e == 'variable') return L(ht);
      return k(j, H(';'), pt);
    }
    function ht(e, t) {
      if (t == 'in' || t == 'of') {
    ...
    function bt(e, t) {
      if (e == 'variable' || C.style == 'keyword') {
        C.marked = 'property';
        if (t == 'get' || t == 'set') return L(wt, vt, bt);
        return L(vt, bt);
      }
      if (t == '*') {
        C.marked = 'keyword';
    ...
    var r = t.indentUnit;
    var i = n.statementIndent;
    var s = n.jsonld;
    var o = n.json || s;
    var u = n.typescript;
    var a = n.wordCharacters || /[\w$\xa1-\uffff]/;
    var f = (function () {
      function e(e) {
    ...
    var l = /[+\-*&%=<>!?|~^]/;
    var c = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/;
    var p, d;
    var w = '([{}])';
    var S = {
      atom: true,
    ...
    return {
      startState: function (e) {
        ...
        if (n.globalVars && typeof n.globalVars == 'object') t.globalVars = n.globalVars;
        return t;
      },
      token: function (e, t) {
        if (e.sol()) {
        ...
        if (p == 'comment') return n;
        t.lastType = p == 'operator' && (d == '++' || d == '--') ? 'incdec' : p;
        return N(t, n, p, d, e);
      },
      indent: function (t, s) {
        ...
        if (u.type == 'stat' && o == '}') u = u.prev;
        if (i && u.type == ')' && u.prev.type == 'stat') u = u.prev;
        var l = u.type,
          c = o == l;
        if (l == 'vardef') return u.indented + (t.lastType == 'operator' || t.lastType == ',' ? u.info + 1 : 0);
        else if (l == 'form' && o == '{') return u.indented;
        else if (l == 'form') return u.indented + r;
        else if (l == 'stat') return u.indented + (t.lastType == 'operator' || t.lastType == ',' ? i || r : 0);
        else if (u.info == 'switch' && !c && n.doubleIndentSwitch != false) return u.indented + (/^(?:case|default)\b/.test(s) ? r : 2 * r);
        else if (u.align) return u.column + (c ? 0 : 1);
        else return u.indented + (c ? 0 : r);
      },
