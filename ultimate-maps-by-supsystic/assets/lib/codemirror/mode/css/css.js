(function (e) {
    ...
    N.block = function (e, t, n) {
      if (e == 'word') {
        ...
        if (u.hasOwnProperty(r)) {
          ...
          d = t.match(/^\s*:(?:\s|$)/, false) ? 'property' : 'tag';
          return 'block';
        } else {
          d += ' error';
          return 'maybeprop';
  ...
  var h = [
    ...
    p = t(h);
  var d = ['font-family', 'src', 'unicode-range', 'font-variant', 'font-feature-settings', 'font-stretch', 'font-weight', 'font-style'],
    v = t(d);
  var m = n.concat(i).concat(o).concat(a).concat(l).concat(h);
  e.registerHelper('hintWords', 'css', m);
