...
umsMapboxMarker.prototype._createMarkerObj = function () {
  var pos = this._markerParams.position && typeof this._markerParams.coord_x === 'undefined' ? [this._markerParams.position.lng, this._markerParams.position.lat] : [this._markerParams.coord_y, this._markerParams.coord_x];
