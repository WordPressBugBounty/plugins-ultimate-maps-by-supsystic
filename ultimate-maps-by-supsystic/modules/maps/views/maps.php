...
class mapsViewUms extends viewUms {
	...
	public function getTabContent() {
		...
		frameUms::_()->addJSVar('admin.maps.list', 'umsTblDataUrl', uriUms::mod('maps', 'getListForTbl', array('reqType' => 'ajax', '_wpnonce' => wp_create_nonce('ums_nonce'))));
	...
	public function getEditMap($id = 0) {
		...
		// jqGrid tables urls
		$umsMarkersTblDataUrl =  uriUms::mod('marker', 'getListForTbl', array('reqType' => 'ajax', 'map_id' => $id, '_wpnonce' => wp_create_nonce('ums_nonce')));
	...
	private function _getMapLeaFletTypes($engine) {
		...
		switch($engine) {
			...
			case 'l-thunderforest':
				$types = array(
					'cycle' => array('label' => __('OpenCycleMap', UMS_LANG_CODE),
						'attr' => '© <a href="http://www.thunderforest.com/">Thunderforest</a> | © <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'),
			...
			case 'leaflet':
				...
				case 'l-maptiles':
					$types = array(
						'en' => array('label' => __('English world map', UMS_LANG_CODE), 'attr' => '© <a href="https://www.maptilesapi.com/">Map Tiles API</a> | © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>'),
						'es' => array('label' => __('Spanish world map', UMS_LANG_CODE), 'attr' => '© <a href="https://www.maptilesapi.com/">Map Tiles API</a> | © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>'),
						'fr' => array('label' => __('French world map', UMS_LANG_CODE), 'attr' => '© <a href="https://www.maptilesapi.com/">Map Tiles API</a> | © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>'),
					);
					break;
		}
		return $types;
