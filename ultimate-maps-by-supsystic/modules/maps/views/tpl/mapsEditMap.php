<form id="umsMapForm">
    ...
    <tr>
        ...
        <td>
            <?php echo htmlUms::text('map_opts[title]', [
    ...
    <tr>
        ...
        <td>
            <div class="sup-col sup-w-25">
                <?php echo htmlUms::text('map_opts[width]', [
            ...
            <div class="sup-col sup-w-75">
                <label class="supsystic-tooltip" title="<?php esc_attr_e('Pixels', UMS_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;"><?php echo htmlUms::radiobutton('map_opts[width_units]', [
  'value' => 'px',
  'checked' => $this->editMap ? htmlUms::checkedOpt($this->map['params'], 'width_units', 'px') : false,
]); ?>&nbsp;<?php esc_html_e('Px', UMS_LANG_CODE); ?></label>
                <label style="margin-right: 15px; position: relative; top: 7px;"><?php echo htmlUms::radiobutton('map_opts[width_units]', [
                  'value' => '%',
    ...
    <tr>
        <th scope="row">
            ...
            <i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php esc_attr_e(
              'Your map height. If Adapt map to screen height option is checked - map height will be recalculated on frontend and can be equals to: 1) your device screen height - height from top of page to top of map (if screen height > height from top of page to top of map) 2) your device screen height (in other cases) Recalculation will be done for maps in page content and widgets except of maps which displaying in Ultimate Maps by Supsystic widget popup (Display as image mode).',
              UMS_LANG_CODE,
            ); ?>"></i>
        </th>
        <td>
            <div class="sup-col no-p">
                <div class="sup-col sup-w-50 umsMainHeightOpts" style="padding-right: 15px;">
                    <?php echo htmlUms::text('map_opts[height]', [
                ...
                <div class="sup-col sup-w-25 no-p umsMainHeightOpts">
                    <label class="supsystic-tooltip" title="<?php esc_attr_e('Pixels', UMS_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;"><?php echo htmlUms::radiobutton('map_opts_height_units_is_constant', [
  'value' => 'px',
  'checked' => true,
]); ?>&nbsp;<?php esc_html_e('Px', UMS_LANG_CODE); ?></label>
                </div>
                <div class="sup-col sup-w-25 no-p">
                    <label>
                        <?php echo htmlUms::checkboxHiddenVal('map_opts[adapt_map_to_screen_height]', [
    ...
    <td>
        <div class="sup-col sup-w-100">
            <?php echo htmlUms::selectbox('map_opts[navigation_bar_mode]', [
    ...
    <td colspan="2" style="padding: 0;">
        <table class="form-table">
            <tr>
                ...
                <td>
                    <?php echo htmlUms::selectbox('map_opts[draggable]', [
                      'options' => [
                ...
                <th scope="row">
                    ...
                    <i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php esc_attr_e(
                      'Sometimes you need to disable the possibility to zoom your map using the mouse wheel. This can be required, for example, if you need to use your wheel for some other action, such as scrolling your site even if the mouse is over your map.',
                      UMS_LANG_CODE,
                    ); ?>"></i>
                </th>
                <td>
                    <?php echo htmlUms::checkboxHiddenVal('map_opts[mouse_wheel_zoom]', [
            ...
            <tr>
                ...
                <td>
                    <?php echo htmlUms::checkboxHiddenVal('map_opts[dbl_click_zoom]', [
...
<tr>
    <th scope="row">
        ...
        <i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php esc_attr_e(
          'Sets map center. You can set the map center in the next ways: type an address to use its coordinates, type the coordinates\' values in appropriate fields, or just drag the map on the preview.',
          UMS_LANG_CODE,
        ); ?>"></i>
    </th>
    <td>
        <div>
            ...
            <?php echo htmlUms::text('map_opts[map_center][address]', [
        ...
        <div class="sup-col sup-w-50" style="margin-top: 10px;">
            ...
            <?php echo htmlUms::text('map_opts[map_center][coord_x]', [
        ...
        <div class="sup-col sup-w-50" style="margin-top: 10px;">
            ...
            <?php echo htmlUms::text('map_opts[map_center][coord_y]', [
...
<tr>
    <th scope="row">
        ...
        <i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php esc_attr_e(
          'Sets map zoom.<br /><br /><b>Min Zoom Level</b> - sets the minimum zoom level (maximum estrangement), which can be applied for the map.<br /><br /><b>Max Zoom Level</b> - sets the maximum zoom level (maximum approximation), which can be applied for the map.',
          UMS_LANG_CODE,
        ); ?>"></i>
    </th>
    <td>
        ...
        <div id="zoom_type_options">
            <div style="clear: both;">
                <div class="zoom_level sup-col" style="width: 100%;">
                    ...
                    <?php echo htmlUms::selectbox('map_opts[zoom]', [
                      'options' => $zoomRange,
                ...
                <div class="zoom_min_level sup-col sup-w-50">
                    ...
                    <?php echo htmlUms::selectbox('map_opts[zoom_min]', [
                      'options' => $zoomRange,
                ...
                <div class="zoom_max_level sup-col sup-w-50">
                    ...
                    <?php echo htmlUms::selectbox('map_opts[zoom_max]', [
                      'options' => $zoomRange,
...
<tr>
    ...
    <td>
        ...
        <?php echo htmlUms::selectbox('map_opts[map_type]', [
          'options' => $this->engineOpts['map_type'],
          'value' => $this->editMap && isset($this->map['params']['map_type']) ? esc_attr($this->map['params']['map_type']) : $defMapType,
...
<tr>
    ...
    <td>
        <?php echo htmlUms::selectbox('map_opts[map_stylization]', [
...
<tr>
    ...
    <td>
        <?php echo htmlUms::checkboxHiddenVal('map_opts[marker_hover]', [
...
<tr>
    ...
    <td>
        <?php
        echo htmlUms::selectbox('map_opts[marker_clasterer]', [
          'options' => ['none' => esc_html__('None', UMS_LANG_CODE), 'MarkerClusterer' => esc_html__('Base Clusterization', UMS_LANG_CODE)],
        ...
        $curClusterIcon = uriUms::_(
          $this->editMap && isset($this->map['params']['marker_clasterer_icon']) && $this->map['params']['marker_clasterer_icon'] && $this->map['params']['marker_clasterer_icon'] != $oldDefClasterIcon ? $this->map['params']['marker_clasterer_icon'] : UMS_MODULES_PATH . '/maps/img/m1.png',
        );
        ...
        <div id="umsMarkerClastererSubOpts" style="display: none;">
            <div class="umsClastererSubOpts">
                ...
                <br />
                <div class="sup-col sup-w-75">
                    <?php echo htmlUms::text('map_opts[marker_clasterer_grid_size]', [
                ...
                <div style="margin-top: 10px;">
                    ...
                    <?php echo htmlUms::colorpicker('map_opts[marker_clasterer_background_color]', [
                ...
                <div style="margin-top: 10px;">
                    ...
                    <?php echo htmlUms::colorpicker('map_opts[marker_clasterer_border_color]', [
                ...
                <div style="margin-top: 10px;">
                    ...
                    <?php echo htmlUms::colorpicker('map_opts[marker_clasterer_text_color]', [
...
<tr>
    ...
    <td>
        <?php echo htmlUms::checkboxHiddenVal('map_opts[enable_marker_list_type]', [
        ...
        <div id="umsMapMarkersListSettings" style="display: none;">
            <?php if ($this->isPro) { ?>
                <div style="margin-top:15px;">
                    ...
                    <?php echo htmlUms::hidden('map_opts[markers_list_type]', [
                ...
                <div style="margin-top:15px;" class="slider_simple_table_show">
                    ...
                    <?php echo htmlUms::selectbox('map_opts[slider_simple_table_width_dimension]', [
                      'options' => ['px' => esc_html__('px', UMS_LANG_CODE), '%' => esc_html__('%', UMS_LANG_CODE)],
                    ...
                    <?php echo htmlUms::text('map_opts[slider_simple_table_width_title]', [
                    ...
                    <?php echo htmlUms::text('map_opts[slider_simple_table_width_address]', [
                    ...
                    <?php echo htmlUms::text('map_opts[slider_simple_table_width_description]', [
                    ...
                    <?php echo htmlUms::text('map_opts[slider_simple_table_width_getdirection]', [
                ...
                <div style="margin-top:15px;">
                    <?php echo htmlUms::checkboxHiddenVal('map_opts[hide_empty_block]', [
                ...
                <div style="margin-top:15px;">
                    <?php echo htmlUms::checkboxHiddenVal('map_opts[autoplay_slider]', [
                    ...
                    <?php echo htmlUms::text('map_opts[slide_duration]', [
            ...
            <div style="margin-top: 10px;">
                ...
                <?php echo htmlUms::colorpicker('map_opts[markers_list_color]', [
...
<tr>
    <th scope="row">
        ...
        <i class="fa fa-question supsystic-tooltip" style="float: right;" title="<?php
        esc_attr_e('Add KML files to display custom layers on the map.', UMS_LANG_CODE);
        if (!$this->isPro) {
    ...
    <td>
        <div id="umsKmlFileRowExample" class="umsKmlFileRow" style="display: none;">
            ...
            <?php echo htmlUms::text('map_opts[kml_file_url][]', ['value' => '', 'attrs' => 'class="umsProOpt" style="width: 86%; float: right;" disabled="disabled"']); ?>
        ...
        <?php if (!empty($this->map['params']['kml_import_to_marker']) && count($this->map['params']['kml_import_to_marker'])) {
          foreach ($this->map['params']['kml_import_to_marker'] as $omKey => $oneMarker) {
            $isKmlImpToMarkerVal = 0;
            if ($oneMarker == 'on') {
              $isKmlImpToMarkerVal = 1;
            }
            echo htmlUms::hidden('map_opts[kml_import_to_marker][]', [
...
<tr>
    ...
    <td>
        <?php echo htmlUms::checkboxHiddenVal('map_opts[hide_poi]', [
...
<tr>
    ...
    <td>
        <?php echo htmlUms::checkboxHiddenVal('map_opts[frontend_add_markers]', [
        ...
        <div id="umsAddMarkersOnFrontendOptions" style="display: none;">
            <div style="margin-top: 10px;">
                <?php echo htmlUms::text('umsCopyTextCode', [
            ...
            <div style="margin-top: 10px;">
                <?php echo htmlUms::checkboxHiddenVal('map_opts[frontend_add_markers_logged_in_only]', [
            ...
            <div style="margin-top: 10px;">
                <?php echo htmlUms::checkboxHiddenVal('map_opts[frontend_add_markers_disable_wp_editor]', [
            ...
            <div style="margin-top: 10px;">
                <?php echo htmlUms::checkboxHiddenVal('map_opts[frontend_add_markers_delete_markers]', [
            ...
            <div style="margin-top: 10px;">
                <?php echo htmlUms::checkboxHiddenVal('map_opts[frontend_add_markers_use_markers_categories]', [
            ...
            <div style="margin-top: 10px;">
                <?php echo htmlUms::checkboxHiddenVal('map_opts[frontend_add_markers_use_limits]', [
            ...
            <div id="umsUseLimitsForMarkerAddingOptions" style="display: none; margin-top: 10px;">
                <div class="sup-col sup-w-50">
                    ...
                    <?php echo htmlUms::text('map_opts[frontend_add_markers_use_count_limits]', [
                ...
                <div class="sup-col sup-w-50">
                    ...
                    <?php echo htmlUms::text('map_opts[frontend_add_markers_use_time_limits]', [
    ...
    ?>
        <div class="sup-col" style="padding-right: 0px;">
            <label for="map_opts_marker_infownd_width_units" style="margin-right: 15px; position: relative; top: <?php echo esc_attr($markersInfoWndWidthUnitsLabelStyle); ?>;">
                <?php echo htmlUms::radiobutton('map_opts[marker_infownd_width_units]', [
                  'value' => 'auto',
        ...
        <div class="sup-col sup-w-25">
            <?php echo htmlUms::text('map_opts[marker_infownd_width]', [
    ...
    <td>
        ...
        <div class="sup-col" style="padding-right: 0px;">
            <label for="map_opts_marker_infownd_height_units" style="margin-right: 15px; position: relative; top: <?php echo esc_attr($markersInfoWndHeightUnitsLabelStyle); ?>;">
                <?php echo htmlUms::radiobutton('map_opts[marker_infownd_height_units]', [
                  'value' => 'auto',
        ...
        <div class="sup-col sup-w-25">
            <?php echo htmlUms::text('map_opts[marker_infownd_height]', [
...
<tr>
    ...
    <td>
        <?php echo htmlUms::colorpicker('map_opts[marker_title_color]', [
...
<tr>
    ...
    <td>
        <?php echo htmlUms::colorpicker('map_opts[marker_infownd_bg_color]', [
...
<tr>
    ...
    <td>
        <div class="sup-col sup-w-25">
            <?php echo htmlUms::text('map_opts[marker_title_size]', [
        ...
        <div class="sup-col sup-w-75">
            <label class="supsystic-tooltip" title="<?php echo esc_attr__('Pixels', UMS_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;">
                <?php echo htmlUms::radiobutton('map_opts[marker_title_size_units]', [
                  'value' => 'px',
                  'checked' => true,
...
<tr>
    ...
    <td>
        <div class="sup-col sup-w-25">
            <?php echo htmlUms::text('map_opts[marker_desc_size]', [
        ...
        <div class="sup-col sup-w-75">
            <label class="supsystic-tooltip" title="<?php esc_attr_e('Pixels', UMS_LANG_CODE); ?>" style="margin-right: 15px; position: relative; top: 7px;">
                <?php echo htmlUms::radiobutton('map_opts[marker_desc_size_units]', [
                  'value' => 'px',
                  'checked' => true,
                ]); ?>&nbsp;<?php esc_html_e('Px', UMS_LANG_CODE); ?></label>
        </div>
...
<?php if (isset($this->engineFromReq) && !empty($this->engineFromReq)) {
  echo htmlUms::hidden('map_opts[engine_from_req]', ['value' => $this->engineFromReq]);
} ?>
<?php echo htmlUms::hidden('mod', ['value' => 'maps']); ?>
<?php echo htmlUms::hidden('action', ['value' => 'save']); ?>
<?php echo htmlUms::defaultNonceForAdminPanel(); ?>
<?php echo htmlUms::hidden('map_opts[id]', ['value' => $this->editMap ? esc_attr($this->map['id']) : '']); ?>
<?php echo htmlUms::hidden('map_opts[membershipEnable]', ['value' => isset($this->map['params']['membershipEnable']) ? esc_attr($this->map['params']['membershipEnable']) : 0, 'attrs' => 'id="membershipHiddenEnable"']); ?>
</form>
        ...
        <div class="umsMmlElementBtnShell">
            <a href="<?php echo esc_url(
              frameUms::_()
                ...
                ->generateMainLink('utm_source=plugin&utm_medium=marker_list_' . $lKey . '&utm_campaign=ultimatemaps'),
            ); ?>" target="_blank" class="button button-primary umsMmlApplyBtn" data-apply-label="<?php esc_html_e('Apply', UMS_LANG_CODE); ?>" data-active-label="<?php esc_html_e('Selected', UMS_LANG_CODE); ?>">
