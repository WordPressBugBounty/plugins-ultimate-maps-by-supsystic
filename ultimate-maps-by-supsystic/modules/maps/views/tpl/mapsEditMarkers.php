<form id="umsMarkerForm">
	<table class="form-table">
		<tr>
			...
			<td>
				<?php echo htmlUms::text('marker_opts[title]', [
      'value' => '',
      'attrs' => 'style="width: 100%;" id="marker_opts_title"',
		...
		<tr>
			<th colspan="2">
				<?php wp_editor('', 'markerDescription', [
      //'textarea_name' => 'marker_opts[description]',
      'textarea_rows' => 10,
    ]); ?>
				<?php echo htmlUms::hidden('marker_opts[description]', ['value' => '']); ?>
			</th>
		</tr>
		<tr>
			<th scope="row">
			...
			<td>
				<?php echo htmlUms::hidden('marker_opts[icon]', [
      'value' => 1 /*Default Icon ID*/,
		...
		<tr>
			...
			<td>
				<?php echo htmlUms::text('marker_opts[address]', [
      'value' => '',
      ...
      'attrs' => 'style="width: 100%;" id="marker_opts_address"',
		...
		<tr>
			...
			<td>
				<?php echo htmlUms::text('marker_opts[coord_x]', [
      'value' => '',
      ...
      'attrs' => 'style="width: 100%;" id="marker_opts_coord_x"',
		...
		<tr>
			...
			<td>
				<?php echo htmlUms::text('marker_opts[coord_y]', [
      'value' => '',
      ...
      'attrs' => 'style="width: 100%;" id="marker_opts_coord_y"',
		...
		<tr>
			...
			<td>
				<div style="width: 100%;">
					<?php echo htmlUms::selectlist('marker_opts[marker_group_id]', [
       ...
       'attrs' => 'style="width: 100%;" id="marker_opts_marker_group_id" class="chosen"',
		...
		<tr>
			...
			<td>
				<?php echo htmlUms::checkbox('marker_opts[params][marker_link]', [
      'checked' => '',
      'attrs' => 'id="marker_link" onclick="umsAddLinkOptions()"',
    ]); ?>
				<div id="link_options" style="display: none;">
					<?php echo htmlUms::text('marker_opts[params][marker_link_src]', [
       'value' => '',
       'attrs' => 'style="width: 90%; float: right; margin: 0px 0px 10px 0px;"',
     ]); ?>
					<div style="clear: both;"></div>
					<?php echo htmlUms::checkbox('marker_opts[params][marker_link_new_wnd]', [
       'checked' => '',
     ]); ?>
					<span>
		...
		<tr>
			...
			<td>
				<?php echo htmlUms::checkbox('marker_opts[params][show_description]', [
      'checked' => '',
    ]); ?>
			</td>
		</tr>
...
?>
	...
	<?php echo htmlUms::hidden('mod', ['value' => 'marker']); ?>
	<?php echo htmlUms::hidden('action', ['value' => 'save']); ?>
	<?php echo htmlUms::defaultNonceForAdminPanel(); ?>
	<?php echo htmlUms::hidden('marker_opts[id]', ['value' => '']); ?>
	<?php echo htmlUms::hidden('marker_opts[map_id]', ['value' => $this->editMap ? $this->map['id'] : '']); ?>
	<?php echo htmlUms::hidden('marker_opts[path]', ['value' => '']); ?>
</form>
