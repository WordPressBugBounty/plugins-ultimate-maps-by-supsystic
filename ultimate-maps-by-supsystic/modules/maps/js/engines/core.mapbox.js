...
umsMapboxMap.prototype.enbWheelZoom = function (mode) {
  mode ? this._mapObj.scrollZoom.enable() : this._mapObj.scrollZoom.disable();
};
...
umsMapboxMap.prototype._generateMarkerInfoWndStyle = function () {
  ...
  res.push(this._elementId + ' .mapboxgl-popup .umsMarkerTitle {color: ' + this.getParam('marker_title_color') + '; font-size: ' + this.getParam('marker_title_size') + 'px}');
