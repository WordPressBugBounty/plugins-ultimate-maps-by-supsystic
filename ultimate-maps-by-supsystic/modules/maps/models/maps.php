...
class mapsModelUms extends modelUms
{
  ...
  public function getAllMaps($d = [], $withMarkers = false, $markersWithGroups = false, $withShapes = false, $withHeatmap = false)
  {
  ...
  public function getParamsList()
  {
    $mapOptKeys = dispatcherUms::applyFilters('mapParamsKeys', [
      ...
      'language',
      'enable_zoom',
      'enable_mouse_zoom' /*we used "mouse_wheel_zoom" insted of this - same reason as prev. one*/,
      'mouse_wheel_zoom',
      'zoom_type',
      'zoom',
      'zoom_mobile',
      ...
      'marker_title_color',
      'marker_title_size',
      'marker_title_size_units',
      'marker_desc_size',
      'marker_desc_size_units',
      'hide_marker_tooltip',
      'center_on_cur_marker_infownd',
      'marker_infownd_type',
      'marker_infownd_hide_close_btn',
      'marker_infownd_width',
      'marker_infownd_width_units',
      'marker_infownd_height',
      'marker_infownd_height_units',
      'marker_infownd_bg_color',
      'marker_clasterer',
      'marker_clasterer_icon',
      'marker_clasterer_icon_width',
      'marker_clasterer_icon_height',
      'marker_clasterer_grid_size',
      'marker_clasterer_background_color',
      'marker_clasterer_border_color',
      'marker_clasterer_text_color',
      'marker_filter_color',
      'marker_filter_button_title',
      'marker_hover',

      'slider_simple_table_width_dimension',
      'slider_simple_table_width_title',
      'slider_simple_table_width_address',
      'slider_simple_table_width_description',
      'slider_simple_table_width_getdirection',
  ...
  {
    return ['width', 'height' /*, 'align', 'margin', 'border_width', 'border_color'*/];
  }
          ...
          if ($clonedMapId) {
            ...
            if ($markers) {
              foreach ($markers as $marker) {
                ...
                $dbMarkerRes = $wpdb->insert($tableName, [
                  'title' => $marker['title'],
  ...
  public function prepareDataToClone($data, $newMapId = false, $date = false)
  {
    unset($data['id']);
    if ($newMapId) {
      $data['map_id'] = $newMapId;
    } // We do not need to set map id for maps
    if ($date) {
      $data['create_date'] = date('Y-m-d H:i:s');
    }
    // We need to set date here only for maps amd markers
    else {
  ...
  public function constructMapOptions()
  {
    ...
    $params['align'] = ['top' => 'top', 'right' => 'right', 'bottom' => 'bottom', 'left' => 'left'];
    $params['display_mode'] = ['map' => 'Display Map', 'popup' => 'Display Map Icon'];
    return $params;
  }
  ...
  public function resortMarkers($d = [])
  {
  ...
  public function resortShapes($d = [])
  {
