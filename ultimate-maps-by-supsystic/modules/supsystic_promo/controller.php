...
class supsystic_promoControllerUms extends controllerUms
{
  ...
  {
    return ['welcomePageSaveInfo', 'sendContact', 'addNoticeAction', 'sendSubscribeMail', 'sendSubscribeRemind', 'sendSubscribeDisable'];
  }
  public function getPermissions()
  {
    return [
      UMS_USERLEVELS => [
        UMS_ADMIN => ['welcomePageSaveInfo', 'sendContact', 'addNoticeAction', 'sendSubscribeMail', 'sendSubscribeRemind', 'sendSubscribeDisable'],
      ],
    ];
  }
}
