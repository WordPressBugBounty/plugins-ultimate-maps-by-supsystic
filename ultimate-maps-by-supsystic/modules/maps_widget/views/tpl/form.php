...
<div class="umsWidgetRow umsMapRow">
    ...
    <div class="umsWidgetRowCell umsLastCell">
        <?php echo htmlUms::selectbox($this->widget->get_field_name('id'), [
...
<div class="umsWidgetRow">
    ...
    <div class="umsWidgetRowCell umsLastCell">
        <?php echo htmlUms::text($this->widget->get_field_name('width'), [
...
<div class="umsWidgetRow">
    ...
    <div class="umsWidgetRowCell umsLastCell">
        <?php echo htmlUms::text($this->widget->get_field_name('height'), [
...
<div class="umsWidgetRow">
    ...
    <div class="umsWidgetRowCell umsLastCell">
        <?php echo htmlUms::text($this->widget->get_field_name('map_center'), [
...
<div class="umsWidgetRow">
    ...
    <div class="umsWidgetRowCell umsLastCell">
        <?php echo htmlUms::text($this->widget->get_field_name('zoom'), [
...
<div class="umsWidgetRow">
    ...
    <div class="umsWidgetRowCell umsLastCell">
        <?php echo htmlUms::checkbox($this->widget->get_field_name('display_as_img'), [
        ...
        <div class="umsWidgetSuboptions" id="<?php echo esc_attr($this->widget->get_field_id('img_params_shell')); ?>" style="display: none;">
            <div class="umsWidgetSuboptionsCell">
                ...
                <?php echo htmlUms::text($this->widget->get_field_name('img_width'), [
            ...
            <div class="umsWidgetSuboptionsCell">
                ...
                <?php echo htmlUms::text($this->widget->get_field_name('img_height'), [
