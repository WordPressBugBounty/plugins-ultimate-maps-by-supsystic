jQuery(document).ready(function () {
  ...
  jQuery(document)
    .on('mouseover', '#umsMgrTbl .jqtree-element.jqtree_common', function () {
  ...
  jQuery('#umsMgrRemoveGroupBtn').click(function () {
    ...
    confirmMsg = listIds.length > 1 ? toeLangUms('Are you sur want to remove ' + listIds.length + ' marker categories?') : toeLangUms('Are you sure want to remove "' + mapLabel + '" marker category?');
