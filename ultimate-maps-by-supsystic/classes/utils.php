...
class utilsUms
{
  ...
  {
    if (strpos($plugName, 'wp-content/themes') !== false) {
      //for modules in theme dir
  ...
  public static function activatePlugin()
  {
    global $wpdb;
    if (UMS_TEST_MODE) {
      add_action('activated_plugin', [frameUms::_(), 'savePluginActivationErrors']);
    }
  ...
  public static function umsExtractImgTags($str)
  {
